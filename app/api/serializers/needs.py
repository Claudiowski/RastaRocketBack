...
need_post = api.model('Need POST', {
    ...
    'rate': fields.Float(required=False, description='HT price'),
    'consultants_name': fields.List(fields.String(description='Consultant name', min_length=3, max_length=64),
                                    description='Consultants names', max_items=5),
